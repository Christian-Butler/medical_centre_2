...
--
-- Host: localhost:8889
-- Generation Time: Mar 13, 2022 at 09:29 PM
...
INSERT INTO `company` (`id`, `name`, `address`, `phone_number`, `website`, `description`, `number_of_movies`, `total_box_office`, `date_founded`) VALUES
...
(3, 'Visiting The Shadows', 'Sam Crawford', '2022-03-01', 2, 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don\'t look even slightly believable.', 'comedy,romance', 1),
...
(6, 'Taste Of The Mountains', 'Ginger Hobbs', '2022-03-02', 5, 'There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don\'t look even slightly believable. ', 'comedy,romance', 5),
(7, 'Traces In The Sea', 'Rick Turner', '2022-03-02', 1, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 'romance', 5),
(8, 'Test title', 'Test director', '2022-03-03', 2, 'Test director', 'action,romance', 1);
